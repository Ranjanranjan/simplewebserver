...
<head>
    ...
    <style>
      ...
      .row11
      {
        min-height: 700px; background-color:#ad293c ;
      }
      .row10
      {
        height: 80px;background-color: #eeeeee;
      }
    </style>
</head>
<body>
    <div class="row1">
            ...
            <div style="width: 4%; background-color: #d5d3cb; height: 40px;"></div>
    ...
    <div class="row2" style="border: 3%; position:-webkit-sticky;">
        <div style="width: 6%; background-color: #d5d3cb;"></div>
        <div class="col-3" style="background-color: white; border: 1px;"><img src="kl2.png" alt="saveetha" style="width: 100%; padding-top: 8%;"></div>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" style="height: 600px;">
                ...
                <div class="carousel-inner" style="height: 600px;">
                  <div class="carousel-item active">
                    <img src="zx.jpg" class="d-block w-100" alt="saveetha">
                  </div>
                  <div class="carousel-item">
                    <img src="xc.jpg" class="d-block w-100" alt="saveetha">
                  </div>
                  <div class="carousel-item">
                    <img src="cv.jpg" class="d-block w-100" alt="saveetha">
                  </div>
                  <div class="carousel-item">
                    <img src="vb.jpg" class="d-block w-100" alt="saveetha">
                  </div>
                  <div class="carousel-item">
                    <img src="bn.jpg" class="d-block w-100" alt="saveetha">
                  </div>
                </div>
    ...
    <div class="row10">
            <div class="col-10" style="background-color: #d22c39;height:100px;position: relative;left: 120px;top: 30px;">
                        <div ><img src="ijn.png" alt="" style="width: 20%;position: relative;left: 20px;top: 25px;"></div>
                        <div><i class="bi bi-envelope" style="color: #ffffff; position: relative;left:25%;right: 10%;bottom: 30px   ;font-size: 40px;"><a href="https://saveetha.ac.in/index.php/component/content/?id=7&Itemid=243" style="font-size: 30px;color: #ffffff;text-decoration: none;font-family: 'Nunito';position: relative;bottom: 5px;">Contact us Today</a></i></div>
                        <div><i class="bi bi-telephone-fill" style="color: #ffffff; position: relative;left: 650px;bottom: 90px ;font-size: 40px;"><a href="https://saveetha.ac.in/#"   style="font-size: 30px;color: #ffffff;text-decoration: none;font-family: 'Nunito';position: relative;bottom: 5px;">+91 44 66726677</a></i></div>
                        <div><i class="bi bi-telephone" style="color: #ffffff;font-size: 40px;position:relative;left:980px;bottom: 150px;"></i><a href="https://saveetha.ac.in/#"  style="font-size: 30px;color: #ffffff;text-decoration: none;font-family: 'Nunito';position: relative;left: 980px;bottom: 158px;">+91 44 66726690</a></div>
            </div>
    ...
    <div class="row11" style="display: flex;">
      ...
      <div class="col-2" style="background-color: antiquewhite;"></div>
...
![Screenshot 2024-03-26 153505](https://github.com/Ranjanranjan/simplewebserver/assets/130027697/453ff280-48c3-4693-8124-6dfd46158890)
